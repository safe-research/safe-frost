...
contract FrostVerifier {
    ...
    function _preimage(uint256 rx, uint256 ry, uint256 px, uint256 py, bytes32 message) internal pure returns (bytes memory preimage) {
    ...
    function _expandMessage(bytes memory message, string memory dst, uint256 len) internal view returns (bytes memory uniform) {
        assembly ("memory-safe") {
            uniform := mload(0x40)
    ...
    function _hashToField(bytes memory message, string memory dst) internal view returns (bytes32 e) {
    ...
    function _challenge(uint256 rx, uint256 ry, uint256 px, uint256 py, bytes32 message) internal view returns (bytes32 e) {
        return _hashToField(
